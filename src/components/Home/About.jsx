...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Highly recommend..... Fantastic professional service! I have had a crash repair and a full repaint and my curbed diamond alloys somehow looking like new!!! Amazing service once again thank you,for your outstanding work. 🙏1",
    name: "J B",
  },
